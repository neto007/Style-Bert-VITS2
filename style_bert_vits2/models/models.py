...
class TextEncoder(nn.Module):
    def __init__(
        ...
        self.pt_bert_proj = nn.Conv1d(1024, hidden_channels, 1)
    ...
    def forward(
        ...
        pt_bert_emb = self.pt_bert_proj(pt_bert).transpose(1, 2)
...
class SynthesizerTrn(nn.Module):
    ...
    def forward(
        ...
        x, m_p, logs_p, x_mask = self.enc_p(
            x, x_lengths, tone, language, bert, ja_bert, en_bert, pt_bert, style_vec, sid, g=g
        )
